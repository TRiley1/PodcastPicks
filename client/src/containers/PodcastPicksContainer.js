...
const PodcastPicksContainer = () => {
  ...
  const accessToken =
    "BQC10vbygyhL4ynEhqpBomXwoSIjeLitOw6RDTf0KdPE_P5DjAHPRZcbremdvfMoFrPOUrbZqHy723yrvLUpKdyHnUbINLMqXuRLpiXhOQt61FU12XuL";
    ...
    <>
      <Router>
        ...
        <div classname="home-logo-container">
          ...
          <h2 className="our-picks-header">PodcastPicks</h2>
        </div>
        <Routes>
          <Route
            path="/"
